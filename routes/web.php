...
Route::get('/poles-activites/transport', [PageController::class, 'poleTransport'])->name('poles.transport');
Route::get('/poles-activites/logistique', [PageController::class, 'poleLogistique'])->name('poles.logistique');
