...
<section class="py-16 sm:py-20 lg:py-28 bg-white relative overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-20 left-[5%] w-72 h-72 bg-primary/5 rounded-full blur-3xl animate-float"></div>
        <div class="absolute bottom-20 right-[10%] w-80 h-80 bg-accent/5 rounded-full blur-3xl animate-float-reverse" style="animation-delay: -2s;"></div>
    </div>
...
<section class="py-16 sm:py-20 lg:py-28 bg-gray-50 relative overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute bottom-1/3 left-[5%] w-72 h-72 bg-primary/5 rounded-full blur-3xl animate-float-reverse" style="animation-delay: -3s;"></div>
    </div>
