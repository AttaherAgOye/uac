...
<section class="relative pt-36 pb-24 overflow-hidden" x-data="{ loaded: false }" x-init="setTimeout(() => loaded = true, 100)">
    <div class="absolute inset-0">
        <img src="{{ asset('images/pages/img7.jpeg') }}" alt="Hydrocarbures" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-gradient-to-br from-red-900/95 via-red-800/85 to-red-900/90"></div>
            ...
            <div x-data="{ v: false }" x-intersect:enter="v = true"
                ...
                <div class="relative">
                    <div class="rounded-3xl overflow-hidden shadow-2xl">
                        <img src="{{ asset('images/pages/img8.jpeg') }}" alt="Hydrocarbures" class="w-full h-[480px] object-cover hover:scale-105 transition-transform duration-700">
                    </div>
