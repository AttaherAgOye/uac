        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20" x-data="{ v: false }" x-intersect:enter="v = true">
            @php
                $types = [
                    ...
                    ['name' => 'Camions Industriels', 'desc' => 'Puissance et fiabilité pour l\'industrie et le BTP.', 'icon' => 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', 'gradient' => 'from-amber-500 to-amber-600'],
