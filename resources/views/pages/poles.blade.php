    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid lg:grid-cols-2 gap-20 items-center">
            <div class="order-2 lg:order-1"
                ...
                <div class="relative">
                    <div class="rounded-3xl overflow-hidden shadow-2xl">
                        <img src="{{ asset('images/pages/poles/transport et logistique.jpeg') }}" alt="Transport & Logistique" class="w-full h-[420px] object-cover hover:scale-105 transition-transform duration-700">
                    </div>
...
<section class="py-16 sm:py-20 lg:py-28 bg-white relative overflow-hidden" x-data="{ v: false }" x-intersect:enter="v = true">
    ...
    {{-- Floating modern shapes --}}
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-1/4 left-[-5%] w-64 h-64 bg-amber-100/30 rounded-full blur-3xl animate-float"></div>
        <div class="absolute bottom-1/4 right-[5%] w-80 h-80 bg-orange-50/50 rounded-full blur-3xl animate-float-reverse" style="animation-delay: -2s;"></div>
    </div>
...
{{-- ═══════════════════════════════════════════════════════ --}}
<section class="py-16 sm:py-20 lg:py-28 bg-gray-50 relative overflow-hidden" x-data="{ v: false }" x-intersect:enter="v = true">
    <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-red-400/40 to-transparent"></div>

    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-1/3 right-[5%] w-72 h-72 bg-red-100/30 rounded-full blur-3xl animate-float" style="animation-delay: -1s;"></div>
        <div class="absolute bottom-1/4 left-[-5%] w-64 h-64 bg-red-50/50 rounded-full blur-3xl animate-float-reverse"></div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid lg:grid-cols-2 gap-20 items-center">
            <div class="order-2 lg:order-1"
                ...
                <div class="relative">
                    <div class="rounded-3xl overflow-hidden shadow-2xl">
                        <img src="{{ asset('images/pages/img3.jpeg') }}" alt="Hydrocarbures" class="w-full h-[420px] object-cover hover:scale-105 transition-transform duration-700">
                    </div>
            ...
            <div class="order-1 lg:order-2"
                ...
                <p class="text-gray-600 text-lg leading-relaxed mb-8">
                    Du carburant de haute qualité au service d'entretien, nous sommes toujours à la recherche d'une meilleure expérience de la route. Nous proposons aussi une boutique pour se rafraîchir et se procurer des produits de première nécessité.
                </p>
                <div class="grid grid-cols-2 gap-3 mb-8">
                    @foreach(['Carburant haute qualité', 'Service entretien', 'Lavage auto', 'Boutique intégrée'] as $type)
                        <div class="flex items-center gap-2 p-3 bg-white rounded-xl border border-gray-100">
...
<section class="py-16 sm:py-20 lg:py-28 bg-white relative overflow-hidden" x-data="{ v: false }" x-intersect:enter="v = true">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute bottom-1/4 right-[5%] w-80 h-80 bg-yellow-50/50 rounded-full blur-3xl animate-float-reverse" style="animation-delay: -2s;"></div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-20 items-center">
            <div :class="['transition-all duration-800 ease-out', v ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12']">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <span class="text-xs font-bold text-yellow-700 uppercase tracking-widest">Pôle 5</span>
                ...
                <p class="text-gray-600 text-lg leading-relaxed mb-4">
                    L'huile de coton est une excellente huile alimentaire légère et savoureuse. Utilisée dans l'industrie alimentaire pour produire les margarines.
                </p>
                <p class="text-gray-500 leading-relaxed mb-8">
                    Cette huile est aussi utilisée dans l'industrie pour fabriquer des produits cosmétiques, des savons, des crèmes et des soins pour la peau. La pâte restante est transformée en tourteaux de coton, un excellent aliment pour le bétail.
                </p>
                <div class="flex flex-wrap gap-2 mb-8">
                    @foreach(['Huile alimentaire', 'Margarine', 'Cosmétiques', 'Tourteaux de coton'] as $tag)
                        <span class="px-4 py-1.5 bg-yellow-50 text-yellow-800 rounded-full text-sm font-semibold border border-yellow-200">{{ $tag }}</span>
                    @endforeach
                </div>
            ...
            <div :class="['transition-all duration-800 ease-out delay-200', v ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12']">
                <div class="relative">
                    ...
                    <div class="absolute -top-4 -right-4 w-24 h-24 border-2 border-yellow-200 rounded-3xl -z-10"></div>
                    <div class="absolute -bottom-4 -left-4 w-16 h-16 bg-yellow-100 rounded-2xl -z-10"></div>
                </div>
            </div>
        </div>
    </div>
